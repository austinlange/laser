...
User.prototype.loadByLogin = function(login, callback) {
	console.log("Loading user by login: %s", login);
...
User.searchByFields = function(field, search, callback) {
	DataObject.searchByFields.call(this, User, field, search, callback);
};
